...
@section('header')Registrar nueva disciplina @endsection
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Registrar disciplina</h1>
                            </div>
                            {{ csrf_field() }}
                            @if ($errors->any())
                            ...
                            @endif
                            <form class="user" action="{{ route('disciplinas.store') }}" method="POST"
