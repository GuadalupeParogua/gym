...
@section('header')Registrar nuevo grupo @endsection
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Registrar grupo</h1>
                            </div>
                            {{ csrf_field() }}
                            @if ($errors->any())
                            ...
                            @endif
                            <form class="user" action="{{ route('grupos.store') }}" method="POST"
                                ...
                                <div class="form-group">
                                    <input type="time" class="form-control form-control-user" id="exampleInputEmail"
                                        name="hra_ini" placeholder="Hora inicio" value="{{ old('hra_ini') }}">
                                </div>
                                <div class="form-group">
                                    <input type="time" class="form-control form-control-user" id="exampleInputEmail"
                                        name="hra_fin" placeholder="Hora fin" value="{{ old('hra_fin') }}">
                                </div>
                                <div class="form-group">
                                    <input type="number" class="form-control form-control-user" id="exampleInputEmail"
                                        name="cupo" placeholder="Cupo" value="{{ old('cupo') }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="instructor_id">Instrcutor: </label>
