...
@section('header')Registrar nueva paquete @endsection
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Registrar paquete</h1>
                            </div>
                            {{ csrf_field() }}
                            @if ($errors->any())
                            ...
                            @endif
                            <form class="user" action="{{ route('paquetes.store') }}" method="POST"
                                ...
                                <div class="form-group">
                                    <input type="date" class="form-control form-control-user" id="exampleInputEmail"
                                        name="duracion" placeholder="Duracion" value="{{ old('duracion') }}">
                                </div>
