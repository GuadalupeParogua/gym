...
@section('header')Modificar persona @endsection
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Modificar datos de la persona</h1>
                            </div>
                            @if ($errors->any())
                            ...
                            @endif
                            <form class="user" action="{{ route('personas.update', [$persona->id]) }}" method="POST"
