...
@section('header')Modificar instructor @endsection
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Modificar datos del instructor</h1>
                            </div>
                            @if ($errors->any())
                            ...
                            @endif
                            <form class="user" action="{{ route('personas.instructores.update', [$persona->id]) }}" method="POST"
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="exampleInputEmail"
                                        name="especialidad" placeholder="Especialidad" value="{{ $persona->instructor->especialidad}}">
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <a href="{{ route('personas.instructores.index') }}" class="btn btn-primary btn-user btn-block">
                                            Cancelar
                                        </a>
                                    </div>
                                </div>
